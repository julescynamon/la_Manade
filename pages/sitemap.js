            ...
            <Head>
                ...
                <main className={Styles.container}>
                    ...
                    <ul className={Styles.link}>
                        ...
                        <li><Link href="/hebergements">- Hébergements</Link></li>
                        ...
                        <li><Link href="/activities/courses-camarguaise">- Les courses camarguaises</Link></li>
                        <li><Link href="/activities/animations">- Les animations taurine</Link></li>
                        <li><Link href="/activities/réception">- La sallle de réception</Link></li>
                        <li><Link href="/activities/produits-fermiers">- Nos produits fermiers</Link></li>
                    </ul>
                </main>
        </>
    )
