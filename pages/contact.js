		...
		<>
			...
			<main>
				...
				<div className={Styles.contactContainer} >
					<div className={Styles.containerContent} data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
					...
					<div className={Styles.containerForm} data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
						<form ref={form} onSubmit={handleSubmit(submit)}>
							<div className={Styles.group1}>
								<div className={Styles.formGroup}>
									<label htmlFor="name">Nom</label>
									<input type="text" name="name" id="name" placeholder="Votre nom" { ...register("name") }/>
									{errors.name && <p className={Styles.errorMessage}>{ errors.name.message }</p>}
								</div>
								<div className={Styles.formGroup}>
									<label htmlFor="email">Email</label>
									<input type="email" name="email" id="email" placeholder="Votre email" { ...register("email") }/>
									{errors.email && <p className={Styles.errorMessage}>{ errors.email.message }</p>}
								</div>
							</div>
							<div className={Styles.formGroup}>
								<label htmlFor="message">Message</label>
								<textarea name="message" id="message" cols="30" rows="10" placeholder="Votre message" { ...register("message") }></textarea>
								{errors.message && <p className={Styles.errorMessage}>{ errors.message.message }</p>}
							</div>
							<button className={Styles.btnSub}  disabled={isSubmitting}>Envoyer</button>
